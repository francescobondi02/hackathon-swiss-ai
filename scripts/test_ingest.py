...
def sync_user_table_data(cur, user_id):
    ...
    if (
        "contact.email" in facts
        and facts["contact.email"]
        and not is_placeholder(facts["contact.email"])
    ):
    ...
    if (
        "contact.phone" in facts
        and facts["contact.phone"]
        and not is_placeholder(facts["contact.phone"])
    ):
    ...
    if (
        "identity.address" in facts
        and facts["identity.address"]
        and not is_placeholder(facts["identity.address"])
    ):
